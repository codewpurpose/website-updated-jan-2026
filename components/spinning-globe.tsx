...
const MARKERS: { location: [number, number]; size: number }[] = [
  ...
  { location: [45.50, -73.57],  size: 0.03 },  // Montreal
  { location: [47.61, -122.33], size: 0.03 },  // Seattle
  // South America
  { location: [-23.55, -46.63], size: 0.05 },  // São Paulo
  { location: [-34.60, -58.38], size: 0.04 },  // Buenos Aires
  ...
  { location: [40.42,  -3.70],  size: 0.03 },  // Madrid
  ...
  { location: [5.56,  -0.20],   size: 0.03 },  // Accra
  ...
  { location: [33.34,  44.40],  size: 0.03 },  // Baghdad
  // Asia
  ...
  { location: [14.60, 120.98],  size: 0.04 },  // Manila
  ...
  { location: [27.70,  85.31],  size: 0.03 },  // Kathmandu
  // Oceania
